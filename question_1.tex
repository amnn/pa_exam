...
\begin{prop}
  ...
  \begin{proof}[Proof (ii)]
    ...
    \begin{itemize}
      ...
      \marginnote{Definition of $\sqsubseteq_1$}
      \itemsep.1em
      ...
      \marginnote{Gathering like terms}
      \begin{itemize}
        \itemindent1em
        \itemsep.1em
      ...
      \itemsep.7em
      \step[\imps] $\forall1\leq i,j\leq n.$
      \marginnote{Transitivity of $\leq$}
      \begin{itemize}
        \itemindent1em
        \itemsep.1em
        \step $\min(m_{ij},m_{i,n+1}+m_{n+1,j}) \leq m^\prime_{ij}$
...
\begin{prop}
  ...
  \begin{proof}[Proof (ii)]
    ...
    \begin{itemize}
      ...
      \marginnote{$\max$ is a join w.r.t. $\leq$}
      \begin{itemize}
        \itemindent1em
        \itemsep-.1em
      ...
      \marginnote{Definition of $\sqcup_1$}
    \end{itemize}
  \end{proof}
\end{prop}
