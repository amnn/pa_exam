...
\begin{prop}
  ...
  \begin{proof}[Case]
    ...
    \begin{prooftree}
      ...
      \AXC{$\vdots$}
      \RightLabel{\scriptsize(I.H.)}
      \UIC{$x_1 : A,\ldots,x_n : A,x_{n+1} : A\vdash u^* : A$}
      \RightLabel{\scriptsize($\to$-intro)}
      \UIC{$x_1 : A,\ldots,x_n : A\vdash\lambda x\ldotp u^* : A\to A$}
      \RightLabel{\scriptsize($\to$-elim)}
      \BIC{$x_1 : A,\ldots,x_n : A\vdash t^* \equiv\mathbf{s}(\lambda x\ldotp u^*) : A$}
...
All that remains to be shown is that for those terms and type judgements that do contain the aforementioned, the proposition holds. For this, it suffices to prove that $\sembrack{\mathbf{r}(\mathbf{s}t)} = \sembrack{t}$ (Proposition~\ref{prop:rs-model}).\\[1em]
...
\begin{prop}
  ...
  \begin{proof}[Proof (iii)]
    ...
    \begin{itemize}
      ...
      \step
        By $\exists$-\Elim, let $(\overline{a}^\prime_1,\overline{b}^\prime_1)$ and $(\overline{a}^\prime_2,\overline{b}^\prime_2)$ be sets satisfying the first and second quantifications respectively. As a consequence of the isomorphism (Proposition~\ref{prop:union-product-iso}), $(\overline{a}^\prime_1,\overline{b}^\prime_1)\cup(\overline{a}^\prime_2,\overline{b}^\prime_2) = (\overline{a}^\prime_1\cup\overline{a}^\prime_2,\overline{b}^\prime_1\cup\overline{b}^\prime_2)$.

      \step
        Then ${(\overline{c},(\overline{a}^\prime_1\cup\overline{a}^\prime_2,~\overline{b}^\prime_1\cup\overline{b}^\prime_2))\in\widehat{h}}$ and ${(\overline{a},\overline{b})\subseteq(\overline{a}^\prime_1\cup\overline{a}^\prime_2,~\overline{b}^\prime_1\cup\overline{b}^\prime_2)}$. So from Proposition~\ref{prop:rel-hat-subset} left to right follows.
  ...
  \begin{proof}
    ...
    \begin{itemize}
      ...
      \step
        ...
        \marginnote{\Def-$\widehat{\langle f,g\rangle}$;~\Def-~$\widehat{\cdot}$}

      \step
        \quad$\land~((\overline{a},\overline{x}), \overline{x}^\prime)\in\widehat{\pi}_2)$
      \addtolength{\itemsep}{.2\baselineskip}
      ...
      \step
        \quad$\land~((\overline{a},\overline{x}), \overline{g})\in\widehat{\lambda f}\compose\widehat{\pi_1}$
        \marginnote{\Thm-\ref{prop:rel-hat-comp}}

      \step
        \quad$\land~\overline{x}^\prime\subseteq\overline{x}$
        \marginnote{\Def-$\widehat{\pi_2}$}
      \addtolength{\itemsep}{.2\baselineskip}

      \step
        Left to right follows by \Trans-$\subseteq$.

      \step
        Right to left follows by $\exists$-\Intro, setting $\overline{x}^\prime\triangleq\overline{x}$.
...
\begin{itemize}
  \step
    $\sembrack{\vdash\mathbf{s}\lambda x\ldotp\mathbf{s}\lambda y\ldotp x}$

  \step[=]
    $\top\xrightarrow{\langle\lambda s^\prime,f\rangle}((A\Exp A)\Exp A)\times(A\Exp A)\overset{\App}\longrightarrow A$
    \begin{flalign*}
      \text{where }
...
\begin{itemize}
  \step
    $\sembrack{\vdash\mathbf{s}\lambda x\ldotp\mathbf{s}\lambda y\ldotp y}$
...
\begin{itemize}
  ...
  \step
    Left to right follows by $\exists$-\Elim~to get a $\overline{f}$, followed by another $\exists$-\Elim~to get a $(\overline{g},a^\prime)$ such that $a = a^\prime\land\overline{g}\subseteq\overline{x}$. Furthermore, by $\forall$-\Elim, of the second conjunct we have that $\exists g\in\overline{g}\ldotp~a^\prime=b^{-1}(g)$. The $g$ satisfying the former proposition also exists in $\overline{x}$, being a superset of $\overline{g}$, and we may unify $a^\prime$ with $a$ to get the necessary conclusion.

  \step
    Right to left follows by $\exists$-\Intro, setting $\overline{f}\triangleq\{(\overline{x}, a)\}$.
  ...
  \step
    This step follows by a similar argument to the above.
  ...
  \step
    Left to right follows by $\exists$-\Elim~to get a $j = (\overline{k},a^{\text(iv)})$ such that ${a^{\prime\prime} = b^{-1}(\overline{k},a^{\text(iv)})}$ and then performing a $\forall$-\Elim, to get the proposition $a^{\text(iv)}\in\overline{h}$.

  \step
    Right to left follows by $\exists$-\Intro, setting $\overline{y}\triangleq\{(\overline{k},a^{\text (iv)})\}$
  ...
  \addtolength{\itemsep}{-.2\baselineskip}
  \step
    \quad $\land~\phantom{(}\forall(\overline{h},b^{-1}(\overline{k}, a^{\text (iv)}))\in\overline{x}\ldotp~a^{\text (iv)}\in\overline{h}$
  \addtolength{\itemsep}{.2\baselineskip}
...
\begin{itemize}
  ...
  \step[\iffs]
    ...
    \marginnote{\Def-$\sembrack{t}$}

  \step[\iffs]
    $\exists\overline{h},\overline{k},a^\prime\ldotp~b(b^{-1}(\varnothing,b^{-1}(\{0\},0))) = b(b^{-1}(\overline{h}, b^{-1}(\overline{k},a^\prime)))\land a^\prime\in\overline{h}$
    \marginnote{$b\compose -$}
  ...
  \step[\iffs]
    ...
    \marginnote{$b\compose b^{-1} =\id$}

  \step[\iffs]
    $\exists\overline{h},\overline{k},a^\prime\ldotp~\varnothing =\overline{h}\land b^{-1}(\{0\},0) = b^{-1}(\overline{k},a^\prime)\land a^\prime\in\overline{h}$
    \marginnote{\Def-$=$}
  ...
  \step[\imps]
    $a^\prime\in\varnothing$
    \marginnote{$\land$-\Elim-R}

  \step[\contras]
    $b^{-1}(\varnothing,b^{-1}(\{0\},0))\notin\sembrack{t}$

  \step[\imps]
    $\sembrack{f}\neq\sembrack{t}$\hfill\qed
\end{itemize}
